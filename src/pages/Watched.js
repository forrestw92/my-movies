...
const Watched = () => {
    ...
    const getWatchedMoviesInfo = async () => {
        ...
        const promises = watchedMovies.map(movie => {
            return fetch(`https://api.themoviedb.org/3/movie/${movie.id}?api_key=19ca613dce306abd8309ecbdbd90cbe3`)
    ...
    return (
        <div>
            ...
            <h1 className="text-4xl text-white font-bold underline underline-offset-4 w-full text-center mt-8 mb-8">Watched Movies</h1>
